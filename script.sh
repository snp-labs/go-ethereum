...
GASLIMIT=3000000000
INSECURE="--allow-insecure-unlock --unlock 0 --password password"
DEFALTOPTION="--verbosity ${VERBOSITY} --mine --miner.threads ${MINERTHREADS} --miner.gaslimit ${GASLIMIT} --rpc.gascap ${GASLIMIT}"
            # |           LOG         |               mine option             |                     gas limit                      |
